...
Here you can check out what this depth slicing looks like in a scene like Sponza, taken directly from my engine. The colors represent the index representation in binary looping every
