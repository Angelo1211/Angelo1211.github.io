...
<iframe id="zslice1" class ="slideshow-iframe" src="{{ site.baseurl }}/slides/zslices.html" style = "width:100%; background: blue" frameborder="0" scrolling="no" ></iframe>
