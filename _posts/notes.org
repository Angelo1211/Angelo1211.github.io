...
* TODO What's left [1/9] [11%]
  - [X] Change post date and title.
  - [ ] Review whole post once.
  - [ ] Update github readme for project.
  - [ ] Check every link is working
  - [ ] Check github readme for correctness
  - [ ] Check names in github readme are correct
  - [ ] Update about page.
  - [ ] Write twitter messages.
  - [ ] Write reddit post.
  - [ ] Message Kostas
  - [ ] Mesage Eric
* Scrapped points
